...
#plot
LandCoverPlot(ET_predicted_diff, legend_title = 'ET difference', font_size = 15)
...
LandCoverPlot(ET_predicted_diff, legend_title = 'ET difference', font_size = 15, low = 'blue', high = 'red')
...
# plot
LandCoverPlot(lc_raster, value_type = 'categorical', legend_title = 'Landcover type', font_size = 15)
...
LandCoverPlot(lc_raster, value_type = 'categorical', legend_title = 'Landcover type', RColorBrewer_palette = 'Set3', font_size = 15)
...
# plot
LandCoverPlot(ET_predicted_diff, value_type = 'priority', decimal_points = 2, legend_title = 'Change in ET', font_size = 15)
...
LandCoverPlot(ET_predicted_diff, value_type = 'priority', decimal_points = 2, priority_colors = c('black', 'tan', 'orange', 'blue', 'gray', 'limegreen'), legend_title = 'Change in ET', font_size = 15)
...
# specify an outlier
LandCoverPlot(ET_predicted_diff, value_type = 'priority', decimal_points = 2, legend_title = 'Change in ET', font_size = 15, priority_outlier_value = 1)
