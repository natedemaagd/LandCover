...
# plot
LandCoverPlot(pred_values[[6]], value_type = 'priority', decimal_points = 2, legend_title = 'Change in ET', font_size = 20)
...
LandCoverPlot(pred_values$`Predicted values raster, post-invasion`, value_type = 'priority', decimal_points = 2, priority_colors = c('black', 'tan', 'orange', 'blue', 'gray', 'limegreen'),
