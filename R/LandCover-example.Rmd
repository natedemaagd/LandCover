...
set.seed(1)
library(LandCover); library(gridExtra); library(ggplot2); library(raster); library(foreach); library(latex2exp)
...
plot_PredictedVsActual <- ggplot(data = dat) +
  ...
  labs(x = TeX('$ET - \\widehat{ET}$'), y = 'Number of pixels', fill = 'Landcover', color = 'Landcover')
