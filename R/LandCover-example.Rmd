...
plot_PredictedVsActual <- ggplot(data = dat) +
  geom_histogram(aes(x = ET_predicted - ET, fill = as.character(landcover), color = as.character(landcover)), alpha = 0.5, bins = 40) +
  geom_vline(xintercept = 0, linetype = 'longdash') +
  labs(x = 'E(ET) - ET', y = 'Number of pixels', fill = 'Landcover', color = 'Landcover')
