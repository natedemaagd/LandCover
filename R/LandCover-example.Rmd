...
library(sp); library(tidyr); library(rgdal); library(tidyverse); library(viridis)
...
simulation_plots <- SimulationPlots(sim_results = landcover_sim, infest_val = 1, dep_var_label = 'Change in ET', dep_var_modified_label = 'Change in\nmodified ET',
                                    font_size = 15, color_labels = c('ET', 'Modified ET'), flip_colors = TRUE)
...
# plot four landcover plots
lc_timelapse <- grid.arrange(simulation_plots$lc_plot_timelapse[[1]],
                             simulation_plots$lc_plot_timelapse[[6]],
                             simulation_plots$lc_plot_timelapse[[11]],
                             simulation_plots$lc_plot_timelapse[[16]])


# plot four dep_var rasters
dep_var_timelapse <- grid.arrange(simulation_plots$dep_var_plot_timelapse[[1]],
                                  simulation_plots$dep_var_plot_timelapse[[6]],
                                  simulation_plots$dep_var_plot_timelapse[[11]],
                                  simulation_plots$dep_var_plot_timelapse[[16]])


# plot four modified dep_var rasters
dep_var_modified_timelapse <- grid.arrange(simulation_plots$dep_var_modified_plot_timelapse[[1]],
                                           simulation_plots$dep_var_modified_plot_timelapse[[6]],
                                           simulation_plots$dep_var_modified_plot_timelapse[[11]],
                                           simulation_plots$dep_var_modified_plot_timelapse[[16]])
