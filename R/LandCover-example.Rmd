...
File setup. Here we load the packages we'll use in this tutorial, including the `LandCover` package. The others are used for plotting figures and working with rasters.

```{r file setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)

set.seed(42)
library(LandCover); library(gridExtra)library(ggplot2); library(raster)
